  ...
  <div class="avatar">
    <el-container>
      <el-aside v-if="showActions" width="220px" height="840px">
        <el-row>
          <el-button
            style="width: 160px; margin-bottom: 16px"
            @click="start()"
            type="primary"
            >启动</el-button
          >
        ...
        avatarPlatform2
          ...
          .on(SDKEvents.nlp,  (nlpData) => {
            ...
            if (nlpData.index == 0 && nlpData.text.includes("中午")) {
                ...
                // nlpData.text = "哈哈哈，阻止进一步回答喽";
                // nlpData.answer.text = "哈哈哈，阻止进一步回答喽!我不好呀！";
                // nlpData.ttsAnswer.text = "哈哈哈，阻止进一步回答喽!我不好呀！";
                // nlpData.content = "哈哈哈，阻止进一步回答喽!我不好呀！"
                // nlpData.displayContent = "哈哈哈，阻止进一步回答喽!我不好呀！"
                nlpData.status = 2;
                console.info("阻止进一步回答...");
            }
          })
          ...
          .on(SDKEvents.asr,  (asrData) => {
            ...
            // if (asrData.text.includes("你好")) {
            //     asrData.text = "哈哈哈，阻止进一步回答喽";
            //     this.interrupt();
            //     console.info("识别阶段阻止进一步回答...");
            // }
          })
